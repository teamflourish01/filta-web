            ...
            <div className="notable-ol">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "Just tap your NFC card on a compatible smartphone, and your contact information is instantly shared. No apps or Bluetooth required.",
                  index: 6,
                },
                {
                  question: "Can I customize my NFC card?",
                  answer:
                    "Yes, our NFC cards are fully customizable, allowing you to design them to match your brand’s identity.",
                  index: 7,
                },
                {
                  question: "Do NFC cards work with all smartphones?",
                  answer:
                    "NFC cards are compatible with most modern smartphones that support NFC technology. However, older models may not have NFC capabilities.",
                  index: 8,
                },
              ].map(({ question, answer, index }) => (
                <div className={`notable-card-${index + 1}`} key={index}>
            ...
            <div className="notable-ol">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "Digital review cards make it easier for customers to leave reviews, which can enhance your online reputation and attract more clients.",
                  index: 10,
                },
                {
                  question: "Are digital review cards customizable?",
                  answer:
                    "Yes, you can customize your digital review cards with your brand’s logo, colors, and personalized messages to make them more engaging.",
                  index: 11,
                },
                {
                  question: "How do I share a digital review card?",
                  answer:
                    "You can share your digital review card via email, text, or social media, making it easy for customers to leave a review from any device.",
                  index: 12,
                },
              ].map(({ question, answer, index }) => (
                <div className={`notable-card-${index + 1}`} key={index}>
            ...
            <div className="notable-ol">
              {[
                ...
                },
                {
                  ...
                  answer:
                    "Our platform allows you to create a professional email signature by selecting a template, adding your details, and customizing the design to match your brand.",
                  index: 14,
                },
                {
                  question: "Can I include links in my email signature?",
                  answer:
                    "Yes, you can include clickable links to your website, social media profiles, and other online resources in your email signature.",
                  index: 15,
                },
                {
                  question: "Why is an email signature important?",
                  answer:
                    "A well-designed email signature enhances your professionalism, provides easy access to your contact information, and promotes your brand with every email you send.",
                  index: 16,
                },
              ].map(({ question, answer, index }) => (
                <div className={`notable-card-${index + 1}`} key={index}>
