    ...
    <>
      ...
      <div className="res-detail-container">
        <div className="res-detail-content">
          <div className="title-res-detail">The Impact of Technology on</div>
          <div className="img-res-detail">
            <img src={detailImg} alt="dettail-desc-img-res" className="resc-detail-img" />
          </div>
          <p className="date-res-detail">August 20, 2022</p>
          ...
          <p className="res-detail-desc bottom-p-res">
