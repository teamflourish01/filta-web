...
import AOS from "aos";
import multi from "../../assets/multil.svg";
import aipower from "../../assets/aipower.svg";
import leadf from "../../assets/leadf.svg";
import persnalf from "../../assets/persnalmessage.svg"
import voice from "../../assets/voicefirst.svg"
import socialw from "../../assets/socialw.svg"
      ...
      <div className="feature-1320">
        ...
        >
          ...
          >
            ...
            />
                   <div className="img-overlay-flex">
              <img className="imgexp" src={voice} alt="" srcset="" />
            </div>
          ...
          >
            ...
            />
            <div className="img-overlay-flex">
              <img className="imgexp" src={multi} alt="" srcset="" />
            </div>
          ...
          >
            ...
            />
            <div className="img-overlay-flex">
              <img className="imgexp" src={leadf} alt="" srcset="" />
            </div>
          ...
          >
            ...
            />
             <div className="img-overlay-flex">
              <img className="imgexp" src={aipower} alt="" srcset="" />
            </div>
          ...
          >
            ...
            />
             <div className="img-overlay-flex">
              <img className="imgexp" src={persnalf} alt="" srcset="" />
            </div>
          ...
          >
            ...
            />
              <div className="img-overlay-flex">
              <img className="imgexp" src={socialw} alt="" srcset="" />
            </div>
